...
class Sort extends LogicBase
{
	...
	public function getChilds(){
		return \think\Db::query("SELECT b.id,b.title,count(a.cateid) as num FROM ".DB_PREFIX."posts as a  RIGHT JOIN ".DB_PREFIX."sort as b ON a.cateid=b.id WHERE b.parentid=1 and a.channel=1 and a.ischeck=1 GROUP BY b.id");
	}

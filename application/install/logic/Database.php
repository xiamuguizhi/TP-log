...
class Database extends LogicBase
{
  ...
  'WEB_SITE_CLOSE_DES'=>'网站维护中，请稍后访问，感谢您的谅解',
  'ADMIN_LOGIN_LLIMIT_IP'=>'',
  'ADMIN_LOGIN_VERIFY_SWITCH'=>0,
  'tw_reply' => '1',
  'links_push' => '0',
  'comment_need_push' => '0',
  'site_seo_title' => 'TP-Blog',
  'site_seo_keywords' => 'TP-Blog,mvc,php,codeigniter,open souce,Tpframe,开源博客',
  'site_seo_description' => 'TP-Blog,codeigniter,Tpframe',
  'allow_upload_pic_type' => 'png,gif,jpg,gif,jpeg',
  'allow_upload_pic_size' => '2048',
  'upload_pic_position' => 'local',
  'comment_check' => '0',
  'comment_time_interval' => '60',
  'comment_needchinese' => '1',
  'comment_length' => '600',
  'blacklist' => '',
  'name_keywords' => '',
  'keywords' => 'fuck|you',
  ...
  'editor' => 'default',
	...
	public function create_admin_account($db,$data,$data_encrypt_key){
		try{
		    ...
		    ('1', '{$username}', '{$password}', '管理员', '{$email}', '', '{$create_date}', 1, '{$ip}','{$create_date}');";
		    $db->execute($sql);

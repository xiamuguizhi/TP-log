...
return array(
    ...
    'Upload_add_files' => '添加文件',
    'Upload_start' => '开始上传',
    'Upload_error_messages' =>array(
        1 => '上传的文件超过了php.ini中的upload_max_filesize大小',
        2 => '上传的文件超过了HTML表单中指定的MAX_FILE_SIZE大小',
        3 => '上传的文件只上传了一部分',
        4 => '没有上传任何文件',
        6 => '缺少一个临时文件夹',
        7 => '文件写入磁盘失败',
        8 => 'PHP扩展名禁用文件上传',
        'post_max_size' => '上传的文件超过了php.ini中的post_max_size大小',
        'max_file_size' => '文件太大',
        'min_file_size' => '文件太小',
        'accept_file_types' => '不允许使用的文件类型',
    ...
    'Image_Editor_Exit' => "退出",
    'Image_Editor_Save' => "保存",
